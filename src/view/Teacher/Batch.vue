                ...
                <div class="notification">
                    <div class="columns">
                        ...
                        <div class="cont-rgt{">
                            <p>导入老师信息模板</p>
                            <p>
                                <a href="babyAdminServer/static/baseExcels/teacher.xlsx">下载模板</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="notification">
                    <div class="columns">
                        ...
                        <div class="control cont-rgt">
                            <input name="pwd" type="password" v-model="passworddate" class="input" placeholder="初始密码"></input>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default{
        ...
        methods:{
            ...
            addstudent () {
                ...
                let that         = this
                var url         = 'tTeacher/importTeacherExcel'
                let schoolId    = auth.getSchoolId();
                let file       = that.file
                let classIddate   = that.classId
                let passdate  = md5(that.passworddate)
                var formData = new FormData();
                console.log(classIddate);
                formData.append('schoolId',schoolId)
                formData.append('file',file)
                formData.append('passWord',passdate)
                formData.append('classId',classIddate)

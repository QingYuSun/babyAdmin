<template>
    <div class="box-wrp" :class="{'collapsed-box':!status.expand}">
        <div class="box-header with-border" >
            ...
            <div class="box-tools pull-right">
                ...
                <button v-if="close" type="button" class="btn btn-box-tool" data-widget="remove">
        ...
        <div v-show="footer" class="box-footer no-padding">

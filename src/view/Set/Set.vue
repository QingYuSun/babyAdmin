        ...
        <expand-box :title="title">
            <div slot="body">
                <div class="box-body no-padding">
                    <div class="columns">
                        <div class="column is-6 is-parent" style="padding-bottom: 80px;">
                            <div class="info-wrp">
                                <div class="control is-horizontal">
                                    <div class="control-label">
                                        <label class="label">幼儿园ID:</label>
                                    </div>
                                    <div class="control is-grouped">
                                        ...
                                        <p class="control is-expanded">
                                            <input class="input" disabled="disabled" v-model="school.schoolId" type="text" placeholder="幼儿园ID" value="1">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    <div class="control-label">
                                        <label class="label">幼儿园Logo:</label>
                                    </div>
                                    <div class="control">
                                        <div class="is-fullwidth newuploadimg" v-if="!image">
                                            <!-- <input type="file"> -->
                                            <input type="file" name="file" id="index" class="file" @change="onFileChange"/> 
                                            <label for="index" class="two-img">上传图片</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded newportrait">
                                            <img v-if="imgUrl==null" src="../../assets/bjgray.png">
                                ...
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="school.schoolName" type="text" placeholder="校园名称">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="school.schoolPhone" type="text" placeholder="单位电话">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                ...
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="school.schoolAddress" type="text" placeholder="校园地址">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="school.zipCode" type="text" placeholder="邮编">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="school.fax" type="text" placeholder="传真号码">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="school.webUrl" type="text" placeholder="校园网站">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                ...
                                <div class="control is-horizontal">
                                    <div class="control-label">
                                        <label class="label">校园简介:</label>
                                    </div>
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <!-- <input class="input" v-model="school.foundingTime" type="text" placeholder="成立时间"> -->
                                            <textarea class="textbox" v-model="school.introduction"></textarea>
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    <div class="control-label">
                                        <label class="label">校园图片:</label>
                                    </div>
                                    <div class="control">
                                        <div class="is-fullwidth newuploadimg" v-if="!image">
                                            <!-- <input type="file"> -->
                                            <input type="file" id="imagesChange" class="file" @change="FileChange"/> 
                                            <label for="imagesChange" class="two-img">上传图片</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded newportrait">
                                            <img v-if="bgimgUrl==null" src="../../assets/bjgray.png">
                                            <img v-else :src="bgimgUrl">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="admin.teacherName" type="text" placeholder="姓名">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="admin.position" type="text" placeholder="职位">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="admin.phoneNum" type="text" placeholder="联系电话">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <input class="input" v-model="admin.teacherEmail" type="text" placeholder="邮箱地址">
                                        </p>
                                    </div>
                                </div>
                                <div class="control is-horizontal">
                                    ...
                                    <div class="control is-grouped">
                                        <p class="control is-expanded">
                                            <button @click="doUpdate" class="button btn-primary two-save">保存</button>
                                        </p>
                                    </div>
                                </div>
                            </div>
...
/*                schoolimages:[],
        ...
        methods:{
            ...
            doUpdate:function () {
                ...
                var schoolPhoneMobile = school.schoolPhone
                if(!(/^1[34578]\d{9}$/.test(schoolPhoneMobile))){
                ...
                var adminphoneNumMobile = admin.phoneNum
                if(!(/^1[3456789]\d{9}$/.test(adminphoneNumMobile))){
                    alert("管理员手机不是完整的11位手机号或者正确的手机号前七位"); 
                    return;
                }
                if (admin.teacherEmail == '') {
                    alert('请填写管理员邮箱');
                    return;
                }
                var formData = new FormData();
                formData.append('schoolId',school.schoolId)
                formData.append('schoolName',school.schoolName)
                formData.append('schoolAddress',school.schoolAddress)
                formData.append('schoolPhone',school.schoolPhone)
                formData.append('zipCode',school.zipCode)
                formData.append('fax',school.fax)
                formData.append('webUrl',school.webUrl)
                formData.append('foundingTime',school.foundingTime)
                formData.append('region',this.street)
                formData.append('headImageurl',this.headImageurlname)
                formData.append('teacherId',admin.teacherId)
                formData.append('name',admin.teacherName)
                formData.append('position',admin.position)
                formData.append('phoneNum',admin.phoneNum)
                formData.append('email',admin.teacherEmail)
                formData.append('bgImageurl',this.bgImageurlname)
                formData.append('introduction',school.introduction)
...
*/
            ...
            beforeRouteEnter (to, from, next) {
                ...
                Vue.http.post(url,reqData).then(function (res) {
                    if(res.body.msg.toUpperCase() == "OK") {
                            let school          = res.body.data.school
                            school.foundingTime = moment(school.foundingTime).format("YYYY-MM-DD")
                            vm.school           = school
                            vm.admin            = res.body.data.administrator
                            if (res.body.data.school.headImageurl == null||res.body.data.school.headImageurl == '') {
                                vm.imgUrl =null
                            }else{
                                vm.imgUrl  = `http://hellobaobei.oss-cn-shanghai.aliyuncs.com/static/images/schoolHead/${res.body.data.school.headImageurl}`  
                            }
                            if (res.body.data.school.bgImageurl == null ||res.body.data.school.bgImageurl == '') {
                                vm.bgimgUrl =null
                            }else{
                                vm.bgimgUrl  = `http://hellobaobei.oss-cn-shanghai.aliyuncs.com/static/images/schoolBackGroundImg/${res.body.data.school.bgImageurl}`
                            }
                            vm.headImageurlname = res.body.data.school.headImageurl
                            vm.bgImageurlname = res.body.data.school.bgImageurl
                            vm.streets = res.body.data.school.region
                            vm.selectedRegion = res.body.data.school.region.substr(0,6)
                    }else{
                        next()
                    }

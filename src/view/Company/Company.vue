        ...
        <div class="columns">
            <div class="column is-3 is-parent">
                <div class="grade-menu">
                    <a @click="addCompany" class="addpading addhover mail-create btn btn-primary btn-block pf-sc-b">新建</a>
                </div>
                <div class="edits-feedback">
                    <input type="text" class="edits-control" placeholder="搜索公司" v-model="studentword">
...
<script>
    ...
    import CompanyAdd from './Add.vue'
    const AddCompanyModalComponent = Vue.extend(CompanyAdd);
    const openAddCompanyModal = (propsData = {}) => {
        return new AddCompanyModalComponent({
...
//            },
    ...
    export default{
        ...
        methods:{
            ...
            addCompany:function () {
                openAddCompanyModal({visible:true,area:this.area,callback:this.success})
            },
        }
    }
</script>

    ...
    <box-modal :title="title" :visible="true" transition="roll">
        <div class="msg-wrp" style="padding-bottom: 0;">
            ...
            <div class="button-group" style="text-align: right;">
                ...
                <div class="control" style="display: inline-block;">
                    <!-- <button type="submit" @click="doAdd" disabled="doCommit" class="button is-primary">提交</button> -->
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            doAdd:function () {
                this.doCommit = true
                var url          = 'tschool/insertSchool'
                var reqData      = this.form
                reqData.region = this.street
                ...
                this.$http.post(url, reqData).then(function (res){
                  ...
                  this.doCommit = true
                   if(res.body.code == '200'){
                       this.$notify({title: '成功',message: '学校添加成功',type: 'success'});
                       // this.$emit('success');
                       this.callback()
                       document.querySelector(".modal-close").click()
                   }else{
                        this.$notify({title: '提示',message: '学校添加失败',type: 'info'});
                        alert(res.body.msg);
                        this.$emit('fail');
